...
def main():
    ...
    PAIRS = [
        ...
        },
        {
            "name": "dual_12mbps",
            "qdisc": root / "qdisc" / "12mbps" / "dual",
            "mahi":  root / "mahimahi" / "12mbps" / "dual",
            "bandwidth": "12Mbps",
        },
        {
            "name": "dual_50mbps",
            "qdisc": root / "qdisc" / "50mbps" / "dual",
            "mahi":  root / "mahimahi" / "50mbps" / "dual",
            "bandwidth": "50Mbps",
        },
        {
            "name": "dual_200mbps",
            "qdisc": root / "qdisc" / "200mbps" / "dual",
            "mahi":  root / "mahimahi" / "200mbps" / "dual",
            "bandwidth": "200Mbps",
        },
    ]
    ...
    for spec in PAIRS:
        ...
        if first:
            run_one_pair_ci_only(
                ...
                alpha=0.05,
                seed=0,
                show_axis=True,   # only show axis for the first one (since they will be stacked vertically)
            )
            first = False
        else: 
            run_one_pair_ci_only(
                ...
                alpha=0.05,
                seed=0,
                show_axis=False,  # hide axis for subsequent ones (since they will be stacked vertically)
            )
